...
bot_token = '6324568840:AAG99dcSS_mno0r9k4ZMjynlsiJ4KtB3fBQ'
...
#if len(erroneous_dumps)!=0:
send_message(f'Good Morning Prashant, the following dumps have bugs:\n')
#else:
 # pass

# Handle the '/start' command to send a message
@bot.message_handler(commands=['Hi'])
def handle_start(message):
    send_message("Hi,Akash thoda jldi aa jaaya kro. pass reh ke bhi itna late. I phone wale ho gye ho ab toh, sala thoda poha tk nhi khilaya ja rhe hai")

@bot.message_handler(commands=['joke'])
def handle_start(message):
    send_message("U are so awesome people get sick sitting beside you!")
